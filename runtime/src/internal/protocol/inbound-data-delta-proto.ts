...
export class InboundDataDeltaProto {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
__init(i:number, bb:flatbuffers.ByteBuffer):InboundDataDeltaProto {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsInboundDataDeltaProto(bb:flatbuffers.ByteBuffer, obj?:InboundDataDeltaProto):InboundDataDeltaProto {
  return (obj || new InboundDataDeltaProto()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsInboundDataDeltaProto(bb:flatbuffers.ByteBuffer, obj?:InboundDataDeltaProto):InboundDataDeltaProto {
...
static startInboundDataDeltaProto(builder:flatbuffers.Builder) {
...
static addDeletedProperties(builder:flatbuffers.Builder, deletedPropertiesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(4, deletedPropertiesOffset, 0);
}
...
static endInboundDataDeltaProto(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  builder.requiredField(offset, 8) // primary_key
  return offset;
}

static createInboundDataDeltaProto(builder:flatbuffers.Builder, classId:number, objectVersion:flatbuffers.Long, primaryKeyOffset:flatbuffers.Offset, propertiesOffset:flatbuffers.Offset, deletedPropertiesOffset:flatbuffers.Offset):flatbuffers.Offset {
  InboundDataDeltaProto.startInboundDataDeltaProto(builder);
  InboundDataDeltaProto.addClassId(builder, classId);
  InboundDataDeltaProto.addObjectVersion(builder, objectVersion);
  InboundDataDeltaProto.addPrimaryKey(builder, primaryKeyOffset);
  InboundDataDeltaProto.addProperties(builder, propertiesOffset);
  InboundDataDeltaProto.addDeletedProperties(builder, deletedPropertiesOffset);
