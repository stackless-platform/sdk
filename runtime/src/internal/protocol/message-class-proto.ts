...
export class MessageClassProto {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
__init(i:number, bb:flatbuffers.ByteBuffer):MessageClassProto {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMessageClassProto(bb:flatbuffers.ByteBuffer, obj?:MessageClassProto):MessageClassProto {
  return (obj || new MessageClassProto()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMessageClassProto(bb:flatbuffers.ByteBuffer, obj?:MessageClassProto):MessageClassProto {
...
static startMessageClassProto(builder:flatbuffers.Builder) {
...
static endMessageClassProto(builder:flatbuffers.Builder):flatbuffers.Offset {
